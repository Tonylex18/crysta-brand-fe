...
import { formatNaira, resolveImageUrl } from '../pages/lib/api';
...
export default function CartModal({ onClose }: CartModalProps) {
  const { cartItems, updateQuantity, removeFromCart, cartSubtotalKobo } = useCart();
  const { user } = useAuth();
          ...
          <>
            ...
            <div className="p-6 border-t border-gray-200 space-y-4">
              ...
              <button
                onClick={() => {
                  setLoading(true);
                  navigate(appendUserId('/checkout', userId));
                }}
                disabled={loading}
